...
if (!empty($errors)) {
    ...
    header('Location: /teams/previous_game_add.php?' . $query);
    exit;
}

try {
    $ctx = UserContext::getLoggedInUserContext();
    PreviousGamesManagement::createGame($ctx, $date, $team1Id, $team2Id, $team1Score, $team2Score);
    
    // Success - redirect to previous games page
    header('Location: /teams/previous_games.php?id=' . $teamId . '&msg=' . urlencode('Game has been added.'));
    exit;
